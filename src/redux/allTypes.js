    ...
    builder
      ...
      .addCase(getAllTypes.fulfilled, (state, action) => {
        const allTypes = action.payload.data.map((type, index) => {
          ...
          type.color = type?.name == "challengers" && "purpleButton" || type?.name == "characters" && "yellowButton200" || type?.name == "contemplators" && "blueButton500" || type?.name == "collaborators" && "pinkButton"
