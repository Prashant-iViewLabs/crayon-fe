...
export default function SingleRadialChart({ series, width, index, isHovered, labelsData, color, hollow = '65%', nameSize = '12px', valueSize = '20px', nameOffsetY = 16, valueOffsetY = -16, max = 100 }) {
